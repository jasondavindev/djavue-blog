"""
Django settings for djavue-blog project.
...
WSGI_APPLICATION = 'djavue-blog.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './djavue-blog.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
